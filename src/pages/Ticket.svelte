<script>
   ...
   import IMask from 'imask';
    ...
    function onBlurElement(e) {
     ...
     onMount(async () => {
         heightTicket = (document.body.clientHeight - 126) + "px";
         var classname = document.getElementsByClassName("input");
         var fakeName = new Date();
         console.log(`Name is = ${fakeName.getTime()}`);
...
<div >
   <div  class="tabs tabs-wrapper top tabs-expand" style="float: left;height:{heightTicket};width: 90%; overflow: auto;" >
